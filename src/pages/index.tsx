    ...
    <div className={`${style.content_area} ${common.clearfix}`}>
      <div className={`${style.main} ${common.clearfix}`}>
        ...
        <div className={style.image_btn_group}>
          <Link className={style.image_btn} to={routerlist.image.pathname} style={{ background: `url('${require("@/public/main/image_btn.jpg")}')`, backgroundSize: "100% 100%" }}>图片视频版权保护</Link>
          <Link className={style.image_btn} to={routerlist.text.pathname} style={{ background: `url('${require("@/public/main/text_btn.jpg")}')`, backgroundSize: "100% 100%" }}>文字版权保护</Link>
        </div>
